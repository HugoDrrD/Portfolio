  ...
  const projects = [
    {
      ...
      description:
        "Ce jeu en C m'a permis d'apprendre la programmation, la gestion de la mémoire en C et d'explorer le front-end. Le projet était principalement en console et m'a offert une bonne base pour travailler avec des structures de données et des algorithmes.",
    },
    {
      title: "ECEcooked",
      type: "Scolaire",
      ...
      description:
        "Ce projet était un jeu beaucoup plus poussé. Nous avons développé une véritable interface graphique avec Allegro, intégré des sprites fournis par une autre école, et ajouté la possibilité de jouer avec des manettes. J'ai aussi amélioré certains sprites avec GIMP pour personnaliser l'apparence du jeu.",
    },
    {
      ...
      description:
        "Ce projet, non axé sur un jeu, visait à étudier l'évolution des espèces au fil du temps. Nous avons utilisé des concepts de théorie des graphes pour analyser les relations entre différentes espèces. J'ai pris en charge toute la partie front-end de ce projet.",
    },
    {
        ...
        description:
          "Pendant mon stage, j'ai développé cette application pour une entreprise de plomberie afin d'optimiser la gestion des commandes. Les utilisateurs pouvaient créer une commande sur un PC et y accéder via un QR code sur un smartphone pour voir les éléments en stock, réduisant ainsi les commandes inutiles.",
      },
  ];
